        ...
        contacts.innerHTML += `<div class="pessoas">
            <div id="pessoa${pessoa.id}">
                <input type="text" class="contact-input" value="${pessoa.nome}" id="nome${pessoa.id}" disabled="disabled" maxlength="21"><input type="text" value="${pessoa.idade}" class="contact-input " id="telefone${pessoa.id}" disabled="disabled" onkeydown="return mascaraTelefone(event)"></div>
                    ...
                    <button class="btn btn-outline-dark" onclick="editar(${pessoa.id})" id="editBtn${pessoa.id}"><i class="bi bi-pencil-fill"></i></button>
                    <button class="btn btn-outline-dark" onclick="concluirEdicao(${pessoa.id})" id="concludeBtn${pessoa.id}" style="display: none;"><i class="bi bi-check-lg"></i></button>
                    <button id="favoritos${pessoa.id}" class="btn btn-outline-dark favorito" onclick="favoritos(${pessoa.id})"><i class="bi bi-star-fill"></i></i></i></button>
                    <button id="removerFavoritos${pessoa.id}" class="btn btn-outline-dark removerfavorito" onclick="removeFavoritos(${pessoa.id})" style="display: none;"><i class="bi bi-star-fill"></i></i></i></button>
                    <button class="btn btn-outline-dark" onclick="deletar(${pessoa.id})" id="deleteBtn"><i class="bi bi-trash-fill"></i></button>
                    </div></div>`
    });
